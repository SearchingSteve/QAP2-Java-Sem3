...
public class MyLine 
{
    ...
    // Default constructor that takes in the coordinates of the two points and initializes line
    ...
    // Method to calculate the gradient angle of the line using the arctangent function
